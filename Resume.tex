...
\fancyhead[C]{
	...
	\\
	gjhartma@uwaterloo.ca \\
	(226) 338-0493 (cell)}{
	197 Zouave Street \\
	Eugenia, Ontario, N0C 1E0 \\
	(519) 924-3273}}
%\headheight 10em
\headheight 2in
\textheight 7in
...
\begin{document}
	...
	\begin{section}{Skills Summary}
		...
		\begin{itemize}
			...
			\item Proficient with C\#, ASP.NET, Ajax, CSS, and Python %TODO?
			\item Experience with C++ Script and GUI scripting
			\item Fair experience with several other programming languages including Visual Basic and Java %TODO?
	...
	\begin{section}{Activities and Interests} \\ %TODO this doesn't feel right here...
		...
		\begin{itemize}
			...
			\item Have released 2 encryption related applications and a Sudoku game %TODO probably could get rid of specifics here?
            ...
            \item Have participated in several programming contests including Google Code Jam and Google AI Challenge
                % TODO knok.me, more on contests? open-source (open ant or something?)
	...
	\begin{section}{Work Experience} \\
        ...
        \begin{subsection}{Game Portability Developer - R\&D}{TransGaming Inc., Toronto, Ontario%TODO TransGaming Technologies Inc?
            }{January -- April 2011}

            \begin{itemize}
                \item Developed strict ANSI C peer-reviewed code
                \item Re-implemented DirectX API functions for WineX (TransGaming Inc's Wine branch) %TODO a bit awkward - brackets?
